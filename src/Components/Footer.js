...
const Footer = () => {
  return (
    <div className="absolute bottom-0 right-0 px-5 py-2 flex items-center">
      <a href="https://twitter.com/frusdev" className="mr-2">
        <svg
          className="hover:scale-150 transform transition-all duration-200"
          width="32"
          height="32"
          viewBox="0 0 48 48"
          fill="none"
      ...
      <a href="https://www.buymeacoffee.com/frus">
        <img
          src="https://media.giphy.com/media/TDQOtnWgsBx99cNoyH/giphy.gif"
          alt=""
          className="w-10 h-10 hover:scale-110 transform transition-all duration-200"
        />
      </a>
    </div>
  );
